...
<!--
  - favicon
-->
<link rel="shortcut icon" href="/assets/dashboard/admin/favicon.svg" type="image/svg+xml">

<!--
  - custom css link
-->
<link rel="stylesheet" href="/assets/dashboard/admin/assets/css/style.css">
                    ...
                    <li>
                        <a href="#" class="header-profile">
                            ...
                            <figure class="profile-avatar">
                                <img src="/assets/dashboard/admin/assets/images/avatar-1.jpg" alt="Elizabeth Foster" width="32" height="32">
                            </figure>
            ...
            <div class="card profile-card">
                ...
                <div class="profile-card-wrapper">
                    ...
                    <figure class="card-avatar">
                        <img src="/assets/dashboard/admin/assets/images/avatar-1.jpg" alt="Elizabeth Foster" width="48" height="48">
                    </figure>
                ...
                <li class="project-item">
                    <div class="card project-card">
                        ...
                        <ul class="card-avatar-list">
                            ...
                            <li class="card-avatar-item">
                                <a href="#">
                                    <img src="/assets/dashboard/admin/assets/images/avatar-2.jpg" alt="John Foster" width="32" height="32">
                                </a>
                            </li>
...
<!--
  - custom js link
-->
<script src="/assets/dashboard/admin/assets/js/script.js"></script>
